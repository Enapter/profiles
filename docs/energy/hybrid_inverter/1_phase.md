...
A profile for single-phase hybrid inverters with integrated PV input and battery management. Covers PV input power, battery state of charge and power, AC output measurements, grid and load power, operational status, and nameplate attributes.
...
- **Type:** `float`
- **Unit:** Hz
- **Inherited from:** [`lib.energy.inverter.ac.1_phase`](../../lib/energy/inverter/ac/1_phase.md)
